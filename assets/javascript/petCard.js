function petCardBuilder(petRef) {
    ...
    card.append($('<div class="card-action"><div class="row"><div class="col s4"><button class="btn"><a class="mapLink modal-trigger" href="#modal1"><i class="material-icons left">location_on</i>Shelter</a></button></div><div class="col s4"><button class="btn"><a class="emailLink" href="mailto:' + petRef.email + '"><i class="material-icons left">mail</i> Email</a></button></div><div class="col s4"><button class="btn"><a class="facebookLink"><i class="material-icons left">share</i>Share</a></button></div></div></div>'));
    return card;
}